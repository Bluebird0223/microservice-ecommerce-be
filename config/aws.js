...
const DYNAMODB_PRODUCT_TABLE = process.env.DYNAMODB_PRODUCT_TABLE;
const DYNAMODB_CART_TABLE = process.env.DYNAMODB_CART_TABLE;
const DYNAMODB_ORDER_TABLE = process.env.DYNAMODB_ORDER_TABLE;
const DYNAMODB_PAYMENT_TABLE = process.env.DYNAMODB_PAYMENT_TABLE;
